...
console.log(color('      THIS SCRIPT IS FOR EVERYONE, NOT FOR SALE','magenta'),color('\n      JIKA DIJUAL NERAKA MENUNGGUMU BROTHER\n\n','magenta'))
    ...
    async function getMessage(key){
        ...
        return {
            conversation: "Hai Im HowCloudDB"
        }
    }
        ...
        try {
            ...
            for (let num of participants) {
                ...
                try {
                    ...
                    ppuser = 'https://tinyurl.com/HowCloudDB'
                }
                ...
                try {
                    ...
                    ppgroup = 'https://tinyurl.com/HowCloudDB'
                }
...
┃┗━━━━━━━━━━━━┛
┗━━━━━━━━━━━━━━┛${intro}${metadata.desc}`
jobotz.sendMessage(anu.id, { text: welkom, contextInfo:{"externalAdReply": {"title": `WELCOME`,"body":`HowCloudDB`, "previewType": "PHOTO", "showAdAttribution": true, "thumbnailUrl": ppuser,"sourceUrl": `https://youtube.com/@thejobot2393`}}})
...
┃┗━━━━━━━━━━━━┛
┗━━━━━━━━━━━━━━┛`
jobotz.sendMessage(anu.id, { text: byebye, contextInfo:{"externalAdReply": {"title": `GOOD BYE`,"body":`DevXyZ`, "previewType": "PHOTO", "showAdAttribution": true, "thumbnailUrl": ppuser,"sourceUrl": `https://youtube.com/@thejobot2393`}}})
